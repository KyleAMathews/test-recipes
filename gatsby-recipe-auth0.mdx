...

{
  ...
  auth0AppPage.pageContext.createImport('import ProtectedRoute from "gatsby-theme-auth0"')
  auth0AppPage.pageContext.setComponent(<ProtectedRoute>You can't see me until you login</ProtectedRoute>)
}

import LoginPage from "gatsby-theme-auth0"

<WritePage page={auth0AppPage.pageContext} />
